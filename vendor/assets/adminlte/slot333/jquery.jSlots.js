(function($){
    ...
    $.jSlots = function(el, options){
        ...
        $.jSlots.defaultOptions = {
            ...
            forcedValues: null  // Thêm tùy chọn này để ép buộc kết quả
        };
        ...
        base.Slot.prototype = {
            ...
            finish: function() {
                ...
                // Use forced value if available
                if (base.options.forcedValues && base.options.forcedValues.length > 0) {
                    endNum = base.options.forcedValues[base.doneCount];
                } else {
